...
import com.example.pagination.data.api.ApiClient.poster_base_url
...
class PopularMovieListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
